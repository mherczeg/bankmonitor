...
| §24 | [Frontend testing: extract logic, unit test it, Playwright end-to-mock](00-initial-decisions.md#24-frontend-testing-extract-logic-unit-test-it-playwright-end-to-mock) | [31](31-frontend-toolchain.md), [32](32-openapi-type-generation.md) |
