...
| [21 — the internal Verdict endpoint](21-internal-verdict-endpoint.md) | a denial gets a problem document once there is a refusal a caller is meant to read, which closes ticket 04's open question; `403` and not `401`, because a bespoke header is no registered authentication scheme to challenge with; the rule on the prefix as an `AuthorizationManager`, held by a test against a path with no handler; the request cache created the session `STATELESS` assumes away — measured; two collaborators as method parameters rather than beans, because beans cost the slice test that proves the rule is on the chain; `200` with a receipt, because `204` makes a Check service ask again for what the response already knew |
...
| §9 | [Verdicts arrive by inbound HTTP callback](00-initial-decisions.md#9-verdicts-arrive-by-inbound-http-callback) | [21](21-internal-verdict-endpoint.md) |
| §10 | [Internal endpoints sit behind a shared secret](00-initial-decisions.md#10-internal-endpoints-sit-behind-a-shared-secret) | [21](21-internal-verdict-endpoint.md) |
...
| §18 | [Errors are RFC 9457 `ProblemDetail`](00-initial-decisions.md#18-errors-are-rfc-9457-problemdetail) | [05](05-problem-detail-contract.md), [09](09-create-account-endpoint.md), [14](14-request-transfer-endpoint.md), [17](17-duplicate-resolution.md), [21](21-internal-verdict-endpoint.md), [32](32-openapi-type-generation.md), [34](34-problem-document-module.md), [39](39-create-account-form.md) |
