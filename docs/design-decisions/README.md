...
| [18 — idempotency under concurrency](18-idempotency-concurrency-tests.md) | the ticket's own start latch measured redundant and dropped, and why redundant apparatus is not free; two races that meet at different statements, chosen by a 20/8/0; a second arming rather than a sibling class, because `@Import` is a context cache key; the two branches ticket 17 could not reach, reached without a line of `src/main` |
...
| [25 — the Exchange Rate client](25-exchange-rate-client.md) | Framework 7 has no `@Recover` and rethrows the last attempt unwrapped, which forces the client into two beans; the retry settings cannot hold their defaults on the record, so every default moved to `application.properties`; §28's `fx.base-url` corrected to `payments.fx.base-url` and its "a real provider is a property change" narrowed to a provider speaking this wire shape; a `200` for the wrong pair checked rather than believed, and a body that will not parse reported as that rather than as a refusal; the deferred read-timeout gap sharpened, and WireMock still not re-added |
...
| [38 — the Accounts screen](38-accounts-list-screen.md) | a table because five aligned figures a row is what one is for; the Currency named once in a column rather than three times in the cells being compared; the Available Balance rendered and never subtracted, where the *fixture* derives it on purpose; `refetchOnWindowFocus` declared rather than inherited, and the absent `staleTime` as the half that carries it; a headless page that cannot be made to lose focus, and the two lines that stand in for one |
| [39 — opening an Account from the screen](39-create-account-form.md) | a rule that had to leave the module owning it — `parseAmount` refused the zero opening balance ticket 09 allows on purpose; the schema registered under `onChange` *and* `onSubmit` prints every message twice, measured; server field messages derived from the failed request rather than written into the form, so correcting the field clears them; the backend's words under each field and this app's words over them, and why the two rules differ |
...
| §3 | [Idempotency lives in the service layer, behind a seam](00-initial-decisions.md#3-idempotency-lives-in-the-service-layer-behind-a-seam) | [16](16-idempotent-execution.md), [17](17-duplicate-resolution.md), [18](18-idempotency-concurrency-tests.md) |
| §4 | [Request handling is three phases](00-initial-decisions.md#4-request-handling-is-three-phases) | [13](13-reserve-funds.md), [14](14-request-transfer-endpoint.md), [16](16-idempotent-execution.md), [17](17-duplicate-resolution.md), [18](18-idempotency-concurrency-tests.md) |
| §5 | [Duplicate resolution](00-initial-decisions.md#5-duplicate-resolution) | [14](14-request-transfer-endpoint.md), [16](16-idempotent-execution.md), [17](17-duplicate-resolution.md), [18](18-idempotency-concurrency-tests.md), [35](35-idempotency-key-module.md) |
| §6 | [Concurrency: pessimistic locks in a deterministic order](00-initial-decisions.md#6-concurrency-pessimistic-locks-in-a-deterministic-order) | [12](12-ordered-account-locking.md), [13](13-reserve-funds.md), [14](14-request-transfer-endpoint.md), [18](18-idempotency-concurrency-tests.md), [20](20-record-verdict.md) |
...
| §15 | [The FX rate is locked at request time](00-initial-decisions.md#15-the-fx-rate-is-locked-at-request-time) | [25](25-exchange-rate-client.md) |
| §16 | [Money is a `long` count of minor units](00-initial-decisions.md#16-money-is-a-long-count-of-minor-units) | [01](01-project-skeleton.md), [06](06-money-and-currency.md), [07](07-conversion-function.md), [09](09-create-account-endpoint.md), [14](14-request-transfer-endpoint.md), [33](33-money-format-module.md), [39](39-create-account-form.md) |
| §17 | [One event stream, thin events, no catch-up](00-initial-decisions.md#17-one-event-stream-thin-events-no-catch-up) | [36](36-sse-event-module.md), [38](38-accounts-list-screen.md) |
| §18 | [Errors are RFC 9457 `ProblemDetail`](00-initial-decisions.md#18-errors-are-rfc-9457-problemdetail) | [05](05-problem-detail-contract.md), [09](09-create-account-endpoint.md), [14](14-request-transfer-endpoint.md), [17](17-duplicate-resolution.md), [32](32-openapi-type-generation.md), [34](34-problem-document-module.md), [39](39-create-account-form.md) |
...
| §21 | [TanStack Router, and TanStack Query owns server state](00-initial-decisions.md#21-tanstack-router-and-tanstack-query-owns-server-state) | [31](31-frontend-toolchain.md), [36](36-sse-event-module.md), [38](38-accounts-list-screen.md) |
| §22 | [TanStack Form + zod, and no global state library](00-initial-decisions.md#22-tanstack-form--zod-and-no-global-state-library) | [14](14-request-transfer-endpoint.md), [39](39-create-account-form.md) |
| §23 | [Bootstrap 5, CSS only, plus CSS Modules](00-initial-decisions.md#23-bootstrap-5-css-only-plus-css-modules) | [31](31-frontend-toolchain.md), [38](38-accounts-list-screen.md), [39](39-create-account-form.md) |
| §24 | [Frontend testing: extract logic, unit test it, Playwright end-to-mock](00-initial-decisions.md#24-frontend-testing-extract-logic-unit-test-it-playwright-end-to-mock) | [31](31-frontend-toolchain.md), [32](32-openapi-type-generation.md), [33](33-money-format-module.md), [34](34-problem-document-module.md), [35](35-idempotency-key-module.md), [36](36-sse-event-module.md), [37](37-playwright-harness.md), [38](38-accounts-list-screen.md), [39](39-create-account-form.md) |
| §25 | [Backend tests run on H2](00-initial-decisions.md#25-backend-tests-run-on-h2) | [01](01-project-skeleton.md), [10](10-list-accounts-and-seed.md), [18](18-idempotency-concurrency-tests.md) |
...
| §27 | [The flaky FX provider: timeouts, retry, then fail to the caller](00-initial-decisions.md#27-the-flaky-fx-provider-timeouts-retry-then-fail-to-the-caller) | [25](25-exchange-rate-client.md) |
| §28 | [The mock FX provider is a real HTTP endpoint inside the app](00-initial-decisions.md#28-the-mock-fx-provider-is-a-real-http-endpoint-inside-the-app) | [24](24-mock-fx-provider.md), [25](25-exchange-rate-client.md) |
