...
export const queryClient = new QueryClient({
  defaultOptions: {
    ...
    mutations: {
      // Declared rather than inherited, for the reason above: only the Transfer `POST`
      // carries an Idempotency Key. See docs/design-decisions/39-create-account-form.md.
      retry: false,
    },
  },
})
